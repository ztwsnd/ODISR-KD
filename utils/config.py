...
def load(config_path):
    with open(config_path, 'r') as fid:
        ...
        # print(yaml_config.base_config,'11111111')
        # print(yaml_config.get("base_config"), "2222222")
        # yaml_config = edict(yaml.load(fid))
    with open(yaml_config.get("base_config"), 'r') as fid:
        base_config = edict(yaml.safe_load(fid))
