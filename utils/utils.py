...
def prepare_train_directories(config, model_type):
    ...
    # yaml_config.get("base_config")
    # print(config.get("train"), '111111111')
...
# Calculate Receptive Fields of Pytorch model
# from https://github.com/Fangyh09/pytorch-receptive-field/blob/master/torch_receptive_field/receptive_field.py
